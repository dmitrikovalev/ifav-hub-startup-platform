...
-- Run connected to startupdb
-- Usage: psql -U postgres -d startupdb -f 03_create_tables.sql
-- =============================================================

-- Grant schema privileges to app user
GRANT USAGE ON SCHEMA public TO startupapp;
GRANT CREATE ON SCHEMA public TO startupapp;
...
-- Grant table-level privileges to app user
GRANT ALL PRIVILEGES ON ALL TABLES    IN SCHEMA public TO startupapp;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO startupapp;
